...
(* OASIS_START *)
(* DO NOT EDIT (digest: 767caa34af2e67a95e3e6e3e3d604ffc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Nick Zalutskiy <nick@zalutskiy.com>"];
          homepage = None;
          synopsis = "termbox bindings for ocaml";
          description = None;
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["termbox_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-ltermbox"])];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\139ÚÈÎü\031Æ^8H§Ë\149¨\019ô";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
